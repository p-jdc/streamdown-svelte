...
<Section {markdown} title="Mathematical Expressions" {isOriginal}>
	Streamdown supports LaTeX math expressions through remark-math and KaTeX, enabling beautiful
	mathematical notation in your markdown.</Section
>
