...
describe('RTL (Right-to-Left) Support', () => {
	it('renders basic RTL text correctly', () => {
		...
		const { container } = render(Streamdown, { props: { content: rtlContent } });
...
`;
		...
		const { container } = render(Streamdown, { props: { content: mixedContent } });
...
`;
		...
		const { container } = render(Streamdown, { props: { content: rtlList } });
...
`;
		...
		const { container } = render(Streamdown, { props: { content: rtlHeadings } });
	...
	it('renders inline code with RTL text', () => {
		...
		const { container } = render(Streamdown, { props: { content: inlineRtl } });
	...
	it('renders links with RTL text', () => {
		...
		const { container } = render(Streamdown, { props: { content: rtlLink } });
	...
	it('preserves bidirectional text ordering', () => {
		...
		const { container } = render(Streamdown, { content: bidiContent });
